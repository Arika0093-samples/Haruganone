...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x309b
#define DXLIB_VERSION_STR _T( "3.09b" )
...
extern	int			MV1GetMeshCategoryVisible(			int MHandle, int MeshCategory, int VisibleFlag ) ;					// モデルのメッシュの種類( DX_MV1_MESHCATEGORY_NORMAL など )毎の表示、非表示を取得する( TRUE:表示  FALSE:非表示 )
